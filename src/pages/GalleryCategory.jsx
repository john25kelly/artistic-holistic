...
const categoryData = {
  landscapes: {
    ...
    items: [
      ...
      { id: 3,  title: 'The Old Building',            image: `${pub}/images/gallery/landscapes/the-old-building.jpg` },
  ...
  seascapes: {
    ...
    items: [
      ...
      { id: 7,  title: 'The Wave (Sold – Repeatable)',                image: `${pub}/images/gallery/seascapes/the-wave.jpg` },
      { id: 8,  title: '34 : We Are Sailing',                         image: `${pub}/images/gallery/seascapes/we-are-sailing.png` },
      { id: 9,  title: 'Seascape Study III',                          image: `${pub}/images/gallery/seascapes/seascape-study.jpg` },
      { id: 10, title: 'The Town Rock, Strangford Lough (Sold)',      image: `${pub}/images/gallery/seascapes/town-rock.jpg` },
      { id: 11, title: 'White Rocks – Children on the Beach (Sold)', image: `${pub}/images/gallery/seascapes/white-rocks.jpg` },
    ],
  },
  'modern-art': {
    label: 'Modern Art',
    ...
    items: [
      ...
      { id: 4, title: 'Abstract (Sold)',     image: `${pub}/images/gallery/modern-art/abstract-sold.jpg` },
