...
/**
 * Returns a URL that renders the Drive file as an image.
 * Works for publicly-shared files without OAuth.
 * The sz parameter controls the max width returned.
 */
export function getDriveImageUrl(fileId, width = 900) {
